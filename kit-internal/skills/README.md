...
| `data-database-design` | 1.1 | `03-database.md` | 34 项（[M] 23，`verify db` 执行） |
| `api-interface-design` | 1.1 | `04-api-design.md` | 38 项（[M] 17，`verify api` 执行） |
...
| OpenAPI 机械解析 | 低 | `verify api` 对 openapi.yaml 的 $ref/operationId 深度校验 |
